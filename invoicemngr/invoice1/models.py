...
class Country(models.Model):
    ...
    iso=models.TextField(null=True)
    def __str__(self):
        return self.name
    
from django.db import models
class Satis(models.Model):
    secenek1=models.SmallIntegerField(unique=True)
    def __str__(self):
        return str(self.secenek1)
class Company(models.Model):
    ...
    satis = models.ForeignKey(Satis, on_delete=models.PROTECT)
...
class Invoice(models.Model):
    ...
    guncelleme = models.BooleanField(default=False)
    eskiinvoice= models.IntegerField(blank=True, null=True)
